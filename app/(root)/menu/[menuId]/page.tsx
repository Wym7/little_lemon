...
import { MenuDetailSkeleton } from "./loading";
    ...
    <section className="grid grid-cols-1 mt-14">
      {loading ? (
        ...
        <div className="flex items-center justify-center">
          <Image
            className="object-cover rounded-bl-xl rounded-tl-xl object-center xl:w-80 xl:h-80 lg:w-80 lg:h-80 w-60 h-72"
            //@ts-ignore
            ...
            height={800}
          />
          <div className="bg-gray-900 rounded-br-xl sm:gap-20 lg:gap-10 md:gap-10 rounded-tr-xl w-[40%] lg:h-80  grid p-8 flex-col xl:h-80 h-72 text-yellow-400">
